...
if("TRUE" STREQUAL "TRUE")
  set(test2_SOURCE_PREFIX /home/user/catkin_ws/src/test2)
  set(test2_DEVEL_PREFIX /home/user/catkin_ws/devel)
  set(test2_INSTALL_PREFIX "")
  set(test2_PREFIX ${test2_DEVEL_PREFIX})
else()
  set(test2_SOURCE_PREFIX "")
  set(test2_DEVEL_PREFIX "")
  set(test2_INSTALL_PREFIX /home/user/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'test2' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/user/catkin_ws/src/test2/${idir}'.  ${_report}")
    endif()
