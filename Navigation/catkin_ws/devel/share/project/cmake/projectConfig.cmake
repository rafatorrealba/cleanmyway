...
if("TRUE" STREQUAL "TRUE")
  set(project_SOURCE_PREFIX /home/user/catkin_ws/src/project)
  set(project_DEVEL_PREFIX /home/user/catkin_ws/devel)
  set(project_INSTALL_PREFIX "")
  set(project_PREFIX ${project_DEVEL_PREFIX})
else()
  set(project_SOURCE_PREFIX "")
  set(project_DEVEL_PREFIX "")
  set(project_INSTALL_PREFIX /home/user/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'project' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/user/catkin_ws/src/project/${idir}'.  ${_report}")
    endif()
